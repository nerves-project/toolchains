defmodule NervesToolchainArmNervesLinuxGnueabihf.MixProject do
  use Mix.Project

  @app :nerves_toolchain_arm_nerves_linux_gnueabihf
  ...
  defp nerves_package do
    [
      ...
      target_tuple: :arm_nerves_linux_gnueabihf,
      artifact_sites: [
  ...
  defp description do
    """
    Nerves Toolchain - arm-nerves-linux-gnueabihf
    """
  end
