defmodule NervesToolchainArmV7NervesLinuxMusleabihf.MixProject do
  use Mix.Project

  @app :nerves_toolchain_armv7_nerves_linux_musleabihf
  ...
  defp nerves_package do
    [
      ...
      target_tuple: :armv7_nerves_linux_musleabihf,
      artifact_sites: [
  ...
  defp deps do
    [
      ...
      {:nerves_toolchain_ctng, "~> 1.11.0", runtime: false}
    ]
  end
