defmodule NervesToolchainX8664NervesLinuxMusl.Mixfile do
  use Mix.Project
  ...
  defp package do
    [maintainers: ["Frank Hunleth", "Justin Schneck"],
     ...
     licenses: ["Apache 2.0"],
     links: %{"Github" => "https://github.com/nerves-project/toolchains/nerves_toolchain_x86_64_nerves_linux_musl"}]
  end
end
