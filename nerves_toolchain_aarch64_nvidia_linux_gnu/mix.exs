defmodule NervesToolchainAarch64NvidiaLinuxGnu.MixProject do
  use Mix.Project

  @app :nerves_toolchain_aarch64_nvidia_linux_gnu
  ...
  defp nerves_package do
    [
      ...
      target_tuple: :aarch64_nvidia_linux_gnu,
      artifact_sites: [
  ...
  defp description do
    """
    Nerves Toolchain - aarch64_nvidia_linux_gnu
    """
  end
